import type { EventsPageData } from "@/content/types";

export const eventsPageData: EventsPageData = {
  suptitle: "Our events",
  title:
    "At the Taiko Foundation, it\u2019s our goal to unlock Ethereum for the masses. We are developing the Taiko ZK-EVM",
