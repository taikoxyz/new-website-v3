...
const Rays: React.FC<SVGProps<SVGSVGElement>> = (props) => {
    return (
        <svg
            {...props}
        ...
        >
            <path
                ...
                stroke="url(#paint0_linear_2157_2504)"
                strokeWidth="21"
                strokeMiterlimit="10"
                strokeLinecap="round"
            ...
            <path
                ...
                stroke="url(#paint1_linear_2157_2504)"
                strokeWidth="21"
                strokeMiterlimit="10"
                strokeLinecap="round"
                className="scaling-line"
            ...
            <path
                ...
                stroke="url(#paint2_linear_2157_2504)"
                strokeWidth="21"
                strokeMiterlimit="10"
                strokeLinecap="round"
                className="scaling-line"
            />
            <defs>
                <linearGradient id="paint0_linear_2157_2504" x1="415.336" y1="596.789" x2="5280.84" y2="596.789" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#6438D6" stopOpacity="0" />
                    <stop offset="0.029" stopColor="#6438D6" stopOpacity="0.209" />
                    <stop offset="0.059" stopColor="#6438D6" stopOpacity="0.418" />
                    <stop offset="0.32" stopColor="#6438D6" stopOpacity="0.597" />
                    <stop offset="0.438" stopColor="#6438D6" stopOpacity="0.743" />
                    <stop offset="0.561" stopColor="#6438D6" stopOpacity="0.857" />
                    <stop offset="0.69" stopColor="#6438D6" stopOpacity="0.937" />
                    <stop offset="0.83" stopColor="#6438D6" stopOpacity="0.985" />
                    <stop offset="1" stopColor="#6438D6" />
                </linearGradient>
                <linearGradient id="paint1_linear_2157_2504" x1="423.336" y1="570.508" x2="5086.84" y2="570.508" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FFC4EC" stopOpacity="0" />
                    <stop offset="0.048" stopColor="#FFC4EC" stopOpacity="0.069" />
                    <stop offset="0.089" stopColor="#FFC5EA" stopOpacity="0.4" />
                    <stop offset="0.194" stopColor="#FFC5E9" stopOpacity="0.58" />
                    <stop offset="0.329" stopColor="#FFC6E7" stopOpacity="0.761" />
                    <stop offset="0.783" stopColor="#FFC6E7" stopOpacity="0.892" />
                    <stop offset="0.913" stopColor="#FFC6E6" stopOpacity="0.971" />
                    <stop offset="1" stopColor="#FFC6E6" />
                </linearGradient>
                <linearGradient id="paint2_linear_2157_2504" x1="0" y1="482.878" x2="5290.84" y2="482.878" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#E81899" stopOpacity="0" />
                    <stop offset="0.064" stopColor="#E81899" stopOpacity="0.162" />
                    <stop offset="0.089" stopColor="#E81899" stopOpacity="0.414" />
                    <stop offset="0.455" stopColor="#E81899" stopOpacity="0.624" />
                    <stop offset="0.617" stopColor="#E81899" stopOpacity="0.787" />
                    <stop offset="0.767" stopColor="#E81899" stopOpacity="0.904" />
                    <stop offset="0.899" stopColor="#E81899" stopOpacity="0.975" />
                    <stop offset="1" stopColor="#E81899" />
                </linearGradient>
            </defs>
        </svg>
    );
