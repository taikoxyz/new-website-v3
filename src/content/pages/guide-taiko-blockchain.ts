export const guideTaikoBlockchainData = {
  ...
  cost: {
    title: "How much does it cost to use Taiko?",
    intro:
    ...
    table: {
      headers: ["Operation", "Ethereum L1", "Taiko"],
      rows: [
  ...
  based: {
    ...
    preamble: "Taiko is designed as a based rollup. When fully realized, based sequencing delivers:",
    points: [
  ...
  agents: {
    title: "How do AI agents work on Taiko?",
    intro:
  ...
  comparison: {
    title: "How does Taiko compare to other L2s?",
    intro: "Taiko’s key differentiator is its trajectory toward based sequencing.",
    headers: ["Feature", "Taiko", "Optimistic Rollups", "Other ZK Rollups", "Sidechains"],
    rows: [
  ...
  getting_started: {
    title: "How do I get started with Taiko?",
    steps: [
      { title: "Step 1: Connect Your Wallet", description: "Add Taiko to MetaMask or any Ethereum-compatible wallet. RPC: https://rpc.mainnet.taiko.xyz. Chain ID: 167000." },
      { title: "Step 2: Bridge Assets", description: "Use the Taiko Bridge (bridge.taiko.xyz) to move ETH from Ethereum L1 to Taiko. Third-party bridges including LiFi, Orbiter, Owlto and Rhino.fi also support Taiko." },
  ...
  faq: {
    ...
    items: [
      { question: "What is the cheapest L2 for AI agents?", answer: "Taiko is one of the cheapest Ethereum L2s for AI agent operations. Simple transfers cost approximately $0.003 and contract interactions cost approximately $0.01. ERC-8004 identity and reputation updates cost under $0.01. These sub-cent fees make high-frequency autonomous operations economically viable." },
      ...
      { question: "What is Taiko’s Chain ID?", answer: "Taiko’s Chain ID is 167000. The RPC endpoint is https://rpc.mainnet.taiko.xyz." },
      { question: "How do I bridge ETH to Taiko?", answer: "Use the Taiko Bridge at bridge.taiko.xyz to move ETH from Ethereum L1 to Taiko. Third-party bridges including LiFi, Orbiter, Owlto and Rhino.fi also support Taiko." },
      { question: "Is Taiko fully decentralized?", answer: "Not yet, but it is designed to be. Today, three independent operators handle block building, which avoids the single-sequencer model most L2s use. The proof system uses multiple independent verifiers. The roadmap progressively moves toward full L1 validator sequencing and permissionless block production." },
      ...
      { question: "Which wallets work with Taiko?", answer: "Any Ethereum-compatible wallet works with Taiko. MetaMask, Rainbow, Coinbase Wallet, Rabby and others. Add the RPC endpoint (https://rpc.mainnet.taiko.xyz) and Chain ID (167000)." },
    ],
  },
