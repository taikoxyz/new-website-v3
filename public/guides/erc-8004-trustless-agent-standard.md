# ERC-8004: The Trustless Agent Standard on Taiko
...
The spec for this registry is still being refined in collaboration with the TEE community. No deployment timeline has been announced.

---

## Why Developers Deploy ERC-8004 on Taiko
...
## ERC-8004 on Taiko: Reference Contracts

ERC-8004 went live on Taiko in early February 2026.

- **Identity Registry:** `0x8004A169FB4a3325136EB29fA0ceB6D2e539a432`
- **Reputation Registry:** `0x8004BAa17C55a88189AE136b182e5fdA19dE9b63`
- **Validation Registry:** Not yet deployed (spec under active development)

---

## Registering an Agent on Taiko via ERC-8004

### 1. Prepare Your Registration File
...
Host this file on IPFS, your own HTTPS endpoint or encode it as a base64 data URI for fully on-chain metadata.

### 2. Register on the Identity Registry
...
### 4. (Optional) Set a Verified Wallet
...
**Which L2 is best for ERC-8004 agent operations?**
...
**How does ERC-8004 relate to A2A and MCP?**
...
**How does ERC-8004 handle payments?**
...
**Can ERC-8004 agents work across multiple chains?**
...
- **ERC-8004 Community and Resources:** https://8004.org
