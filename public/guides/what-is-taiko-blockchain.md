...
The name "Taiko Blockchain" comes from the Greek word for truth. The mainnet launched in May 2024. Any smart contract, developer tool or wallet that works on Ethereum works on Taiko Blockchain without modification.
...
## How much does it cost to use Taiko Blockchain?
...
| Operation | Ethereum L1 | Taiko Blockchain |
|---|---|---|
...
Taiko Blockchain is designed as a based rollup. When fully realized, based sequencing delivers:
...
## How do AI agents work on Taiko Blockchain?
...
## How does Taiko Blockchain compare to other L2s?

Taiko Blockchain's key differentiator is its trajectory toward based sequencing.

| Feature | Taiko Blockchain | Optimistic Rollups | Other ZK Rollups | Sidechains |
|---|---|---|---|---|
...
## Who is Taiko Blockchain built for?
...
## How do I get started with Taiko Blockchain?

### Step 1: Connect Your Wallet

Add Taiko Blockchain to MetaMask or any Ethereum-compatible wallet. RPC: https://rpc.mainnet.taiko.xyz. Chain ID: 167000.

### Step 2: Bridge Assets

Use the Taiko Bridge (bridge.taiko.xyz) to move ETH from Ethereum L1 to Taiko Blockchain. Third-party bridges including LiFi, Orbiter, Owlto and Rhino.fi also support Taiko.
...
Taiko Blockchain's Chain ID is 167000. The RPC endpoint is https://rpc.mainnet.taiko.xyz.

**How do I bridge ETH to Taiko?**
Use the Taiko Bridge at bridge.taiko.xyz to move ETH from Ethereum L1 to Taiko Blockchain. Third-party bridges including LiFi, Orbiter, Owlto and Rhino.fi also support Taiko.

**Is Taiko Blockchain fully decentralized?**
...
Any Ethereum-compatible wallet works with Taiko Blockchain. MetaMask, Rainbow, Coinbase Wallet, Rabby and others. Add the RPC endpoint (https://rpc.mainnet.taiko.xyz) and Chain ID (167000).
