...
export const grantProgramPageData: GrantProgramPageData = {
    ...
    items: [
      {
        date: "Sep 25th, 2024",
        description:
          "Welcome to The Grant Factory, where innovation meets opportunity in the Taiko Ecosystem. Find out more here: https://dorahacks.io/hackathon/grant-factory/detail",
      },
    ],
  },
  mission: {
    ...
    items: [
      {
        ...
        title:
          "Discover and support innovative, talented, and value-aligned developers",
  ...
  community: {
    ...
    title:
      "We believe <span>deeply</span> in the power of the open-source community, particularly Ethereum\u2019s, and welcome all builders who share this vision and believe in a more <span>equitable</span>, <span>permissionless</span>, and <span>transparent future</span>",
