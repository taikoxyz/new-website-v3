import type { BrandAssetsPageData } from "@/content/types";

export const brandAssetsPageData: BrandAssetsPageData = {
  hero: {
  ...
  logo: {
    ...
    logos: [
      { id: 1, img: "/img/brand/logo-pb.svg", background: "#F3F3F3" },
      { id: 2, img: "/img/brand/logo-pw.svg", background: "#10151B" },
      { id: 3, img: "/img/brand/logo-ww.svg", background: "#E81899" },
      {
        id: 4,
    ...
    fonts: [
      {
        ...
        variants: [
          { name: "Clash Grotesk Semibold", weight: 600 },
          { name: "Clash Grotesk Medium", weight: 500 },
        ],
      ...
      },
      {
        ...
        variants: [
          { name: "Public Sans Bold", weight: 700 },
          { name: "Public Sans Medium", weight: 500 },
          { name: "Public Sans Regular", weight: 400 },
        ],
