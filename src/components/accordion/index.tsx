...
const AccordionButton: React.FC<SubChildren> = ({ children }) => {
    return <>{children}</>;
};

const AccordionContent: React.FC<SubChildren> = ({ children }) => {
    return <>{children}</>;
};

AccordionButton.displayName = DisplayNames.BUTTON;
AccordionContent.displayName = DisplayNames.CONTENT;
...
export default Object.assign(Accordion, { Button: AccordionButton, Content: AccordionContent });
